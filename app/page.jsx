...
import Spinner from "./(client)/components/SpinnerLil"
  ...
  return (
    <>
      ...
      <div className=" h-dvh flex flex-col justify-center items-center">
        ...
        <div className=" w-75 h-120 md:w-100 lg:w-25rem  transition-all duration-700 ease-out rounded flex flex-col space-y-10 px-10 justify-center ">
          ...
          {/* Google Login */}
          <button onClick={handleGoogleLogin} className=" bg-blue-600 text-white h-12 rounded flex justify-center items-center">
